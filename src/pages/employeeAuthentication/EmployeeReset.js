...
import { resetPassword } from '../../redux/features/employee/employeeAuthServices';
...
const EmployeeReset = () => {
  ...
  const reset = async (e) => {
    ...
    try {
      const data = await resetPassword(employeeData,resetToken)
          ...
          <div className={styles.form}>
            ...
            <h2>Reset Password</h2>
              ...
              <form onSubmit={reset}>
                ...
                <p><Link to = "/employeelogin">-Login</Link></p>
              </div>
              </form>
